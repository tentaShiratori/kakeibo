...
- 実装済み: apps/web の入出金記録（金額・入出日・メモ、直す・消す、暦月の収支と一覧）、ドメイン（CONTEXT.md / ADR-0001〜0013）、oxlint / oxfmt / vitest、apps/app 初期テンプレ、api Hello World
- 作業中: 暦月の振り返り（一覧を見ている月に揃える）
